...
namespace Wheelmap_Windows.Utils {
    ...
    public class BiDirectionalMap<TFirst, TSecond> {
        ...
        public ICollection<TFirst> KeysFirst {
            get {
        ...
        public ICollection<TSecond> KeysSecond {
            get {
        ...
        public bool Contains(TFirst item) {
            return firstToSecond.ContainsKey(item);
        }
        ...
        public Boolean TryGet(TFirst first, out TSecond second) {
        ...
        public Boolean TryGet(TSecond second, out TFirst first) {
