...
namespace Wheelmap.Tiles {
    public class WheelmapTileManager {
        public static void UpdateDefaultPrimaryTile() {
            ...
            updater.Update(createAppIconTiles());
            updater.Update(createSecondaryIconTiles());

        }

        private static TileNotification createAppIconTiles() {
        ...
        private static TileNotification createSecondaryIconTiles() {

            var square150x150 = TileContentFactory.CreateTileSquare150x150Image();
            square150x150.Image.Src = "ms-appx:///Assets/Tiles/square_150x150/square.png";

            var wide310x150 = TileContentFactory.CreateTileWide310x150Image();
            wide310x150.Image.Src = "ms-appx:///Assets/Tiles/wide_310x150/wide.png";
            wide310x150.Square150x150Content = square150x150;

            var tileContent = TileContentFactory.CreateTileSquare310x310Image();
            tileContent.Image.Src = "ms-appx:///Assets/Tiles/square_150x150/square.png";
            tileContent.Wide310x150Content = wide310x150;
